...
public partial class Activities_SearchActivities : System.Web.UI.Page
{
    ...
    protected void SearchButton_Click(object sender, EventArgs e)
    {
        ...
        //display search results in labels
        NameResultsLabel.Text = "Name: " + name;
        DescriptionResultsLabel.Text = "Description: " + description;
        RatingResultsLabel.Text = "Rating: " + rating;
        DateResultsLabel.Text = "Date Created: " + date;
